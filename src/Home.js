                    ...
                    Data.map((result, index) => (
                        <Grid item xs={12} sm={4} ms={4} key={index}>
                            <Card style={{ padding: "10px", marginBottom: "30px" }}>
                                ...
                                <Box display="flex">
                                    <Avatar sx={{ width: 84, height: 84, bgcolor: red[500], borderRadius: "50px" }} aria-label="recipe">
                                        R
                                    </Avatar>
                                ...
                                <Typography>Estimated Salary: Rs 50 - Rs 60 LPA</Typography>
